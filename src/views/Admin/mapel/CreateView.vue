<template>
  <div class="p-4 sm:ml-64">
    ...
    <div class="card shadow-md pl-4 pr-4">
      <br />
      <form @submit.prevent="addmapels" class="pl-4 pr-4" method="post">
        <div>
          <label
            for="mapel"
            style="color: black"
...
export default {
  ...
  methods: {
    ...mapActions("mapel", ["fetchmapeladd"]),
    addmapels() {
      this.fetchmapeladd(this.addmapel);
      console.log(this.addmapel)
    },
  },
